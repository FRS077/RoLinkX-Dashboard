...
/*
 *   RoLinkX Dashboard v3.7 - Wi-Fi management module (version améliorée pour compatibilité iOS)
 *   Copyright (C) 2024 by Razvan Marin YO6NAM / [www.xpander.ro](https://www.xpander.ro)
 *
 *   Modifications pour iPhone : Ajout ieee80211w=0, pairwise/group=CCMP, proto=RSN
 */
...
/* Update the wpa_supplicant.conf file avec options compat iOS */
$wpaData = 'ctrl_interface=DIR=/var/run/wpa_supplicant GROUP=netdev
update_config=1
ap_scan=1
fast_reauth=1
country=FR
# Options pour compatibilité iPhone/iOS avec XR819
ieee80211w=0
pairwise=CCMP
group=CCMP
proto=RSN' . PHP_EOL;
